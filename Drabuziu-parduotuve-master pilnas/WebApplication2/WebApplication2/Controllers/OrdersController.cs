...
namespace WebApplication2.Controllers
{
    public class OrdersController : Controller
    {
        ...
        [ValidateAntiForgeryToken]
        public ActionResult DeleteConfirmed(int id, string paymentType, string cardNumber, string expiryDate, string cvv, string paypalEmail, decimal? storeCreditAmount)
        {
            Order order = db.Orders.Find(id);
            if (order != null)
            {
            ...
            return RedirectToAction("CancelOrderPayment", "Payments", new
            {
                orderId = id,
                paymentType,
                cardNumber,
